...
\begin{slideb}{3}
  \node[textcolor,right] at (-6,3) {\scalebox{1.2}{\tt \textbackslash documentclass\{ximera\}}};%
  \node[textcolor,right] at (-6,2.5) {\scalebox{1.2}{\tt \textbackslash begin\{document\}}};%
  \node[textcolor,right] at (-6,2) {\scalebox{1.2}{\tt \textbackslash begin\{exercise\}}};%
  \node[textcolor,right] at (-6,1.5) {\scalebox{1.2}{\tt \$1+2= \textbackslash answer\{3\}}};%
  \node[textcolor,right] at (-6,1) {\scalebox{1.2}{\tt \$1+2= \textbackslash answer\{3\}}};%
  \node[textcolor,right] at (-6,.5) {\scalebox{1.2}{\tt \$1+2= \textbackslash answer\{3\}}};%
  \node[textcolor,right] at (-6,0) {\scalebox{1.2}{\tt \textbackslash end\{exercise\}}};%
  \node[textcolor,right] at (-6,-.5) {\scalebox{1.2}{\tt \textbackslash end\{document\}}};%
\end{slideb}
