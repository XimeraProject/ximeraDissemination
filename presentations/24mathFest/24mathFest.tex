...
\begin{slide}{gateway.jpg}
  \node[textcolor] at (0,3) {\scalebox{3}{\huge \shadowtext{\bf GATEWAYS}}};
  \node[textcolor] at (0,0) {\scalebox{3}{\huge \shadowtext{\bf TO}}};
  \node[textcolor] at (0,-3) {\scalebox{3}{\huge \shadowtext{\bf XIMERA}}};
\end{slide}
