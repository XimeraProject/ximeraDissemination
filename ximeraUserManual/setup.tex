...
\begin{enumerate}
  ...
  \verb!anExampleCourse! that contains a directory called
  \verb!theFirstActivity!. We will also create the \verb!anExampleCourse.tex!
  file.
...
\end{verbatim}
  ...
  \item Next we will modify the \verb!anExampleCourse.tex! file in the
        (\verb!anExampleCourse!) directory. Click ``Files," click on the
        (\verb!xandbox!) directory and click on the  (\verb!anExampleCourse!)
        directory, then click the file \verb!anExampleCourse.tex!. Copy and
        paste the
        following in the left-hand side of the window and click ``Save." It may
        complain that you haven't created the \verb!theFirstActivity.tex! file
        yet, but
        that's fine.
...
\end{verbatim}
        ...
        \begin{remark}
          ...
          We also recommend that the directory and the \LaTeX\ file have
          exactly
  ...
  \item Now create your first activity. In your terminal, move to the
        \verb!theFirstActivity!
...
\end{verbatim}
        ...
        Click ``Files" again and navigate to the (\verb!theFirstActivity!)
        folder, open
        \verb!theFirstActivity.tex!,
...
\end{verbatim}
        ...
        \end{remark}
  \item Now add this file to git and commit your changes. Back in the terminal,
