...
version control. This local setup allows authors to preview both \PDF\ and
\HTML\ outputs before publishing the content online. Online content requires
some organization and consistency that isn't require with regular \LaTeX\
