...
\begin{xframe}
    {\sffamily\bfseries Authors} use \LaTeX\ to create their content. Getting started with
    Ximera is easy---all you need is the XimeraLaTeX Package, available on
    CTAN. From
    this single source code, we generate various output: PDF worksheets,
    PDF textbooks, and	PDF solution manuals, and so on. However, Ximera can
    also create
    ...
    activity when deployed to  a Ximera
    server. Students access this content via a URL or an assignment in their LMS.
...
\begin{xframe}
    ...
    \end{center}
    Thank you for your interest in Ximera.  Getting started with Ximera is
    easy---all you need is the XimeraLaTeX Package, available on CTAN. We encourage
    you to contact the team with  any questions you may have.
\end{xframe}
...
\begin{xframe}
    {\sffamily\bfseries Future development} will be directed toward making Ximera materials accessible.
\end{xframe}
...
\begin{xframe}
    ...
    \begin{itemize}
        \item \textit{Lines and curves in space}:
              ...
              \qrcode{https://ximera.osu.edu/mooculus/calculus3/linesAndCurvesInSpace/digInLinesAndCurvesInSpace}
...
\begin{xframe}
    ...
    a U.S.\ Department of Education Open Textbooks Pilot Program grant in the amount of \$2,125,000, from 2024-2026. In the past, the Ximera Project has
