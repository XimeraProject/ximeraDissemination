...
\begin{xframe}
    We should be able to ``zoom-in'' on the heat maps, and then identify the assignment, or see student work.

    We should be able to ``collapse'' the data along averages.
\end{xframe}
